...
#
# Usage:
#   ./app/utilities/fetch-cml.sh <orgAlias> <constraintModelName> [outputFile]
#
# Examples:
#   ./app/utilities/fetch-cml.sh tigerDev TestConstraint
#   ./app/utilities/fetch-cml.sh catalogGold PCM_Constraint_Model ./my-model.cml
# ==============================================================================
