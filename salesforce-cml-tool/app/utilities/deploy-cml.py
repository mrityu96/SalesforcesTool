...
Usage:
    python3 app/utilities/deploy-cml.py <orgAlias> <versionId> <cmlFilePath>
    python3 app/utilities/deploy-cml.py <orgAlias> --model <modelName> <cmlFilePath>

Examples:
    python3 app/utilities/deploy-cml.py tigerDev 9QBbZ0000000eezWAA ./TestConstraint_V1.cml
    python3 app/utilities/deploy-cml.py catalogGold --model TestConstraint ./TestConstraint_V1.cml
